...
PnlMsdcPrdList::DpchAppData::DpchAppData() : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCPRDLISTDATA) {
};
...
PnlMsdcPrdList::DpchAppDo::DpchAppDo() : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCPRDLISTDO) {
	ixVDo = 0;
};
