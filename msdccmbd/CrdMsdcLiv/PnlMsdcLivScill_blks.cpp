...
PnlMsdcLivScill::DpchAppData::DpchAppData() : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCLIVSCILLDATA) {
};
...
PnlMsdcLivScill::DpchAppDo::DpchAppDo() : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCLIVSCILLDO) {
	ixVDo = 0;
};
