...
PnlMsdcLivAlign::DpchAppData::DpchAppData() : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCLIVALIGNDATA) {
};
...
PnlMsdcLivAlign::DpchAppDo::DpchAppDo() : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCLIVALIGNDO) {
	ixVDo = 0;
};
