...
PnlMsdcScfSource::DpchAppData::DpchAppData() : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCSCFSOURCEDATA) {
};
...
PnlMsdcScfSource::DpchAppDo::DpchAppDo() : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCSCFSOURCEDO) {
	ixVDo = 0;
};
