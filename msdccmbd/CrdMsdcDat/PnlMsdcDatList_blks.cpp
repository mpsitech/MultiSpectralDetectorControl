...
PnlMsdcDatList::DpchAppData::DpchAppData() : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCDATLISTDATA) {
};
...
PnlMsdcDatList::DpchAppDo::DpchAppDo() : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCDATLISTDO) {
	ixVDo = 0;
};
