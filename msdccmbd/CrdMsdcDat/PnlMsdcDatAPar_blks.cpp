...
PnlMsdcDatAPar::DpchAppData::DpchAppData() : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCDATAPARDATA) {
};
...
PnlMsdcDatAPar::DpchAppDo::DpchAppDo() : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCDATAPARDO) {
	ixVDo = 0;
};
