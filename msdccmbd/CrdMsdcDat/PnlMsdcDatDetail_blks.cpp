...
PnlMsdcDatDetail::DpchAppData::DpchAppData() : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCDATDETAILDATA) {
};
...
PnlMsdcDatDetail::DpchAppDo::DpchAppDo() : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCDATDETAILDO) {
	ixVDo = 0;
};
