/**
  * \file VecMsdcVMimetype.cpp
  * vector VecMsdcVMimetype (implementation)
...
string VecMsdcVMimetype::getSref(
			const uint ix
		) {
...
string VecMsdcVMimetype::getTitle(
			const uint ix
		) {
