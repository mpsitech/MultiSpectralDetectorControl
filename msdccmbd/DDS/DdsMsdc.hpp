...
#ifndef DdsMsdc_1182984298_hpp
#define DdsMsdc_1182984298_hpp
...
#endif
typedef std::vector<uint8_t> utinyintvec;
struct utinyintvec_AliasTag_t {};
...
#endif
typedef std::vector<uint16_t> usmallintvec;
struct usmallintvec_AliasTag_t {};
...
struct uintvec_AliasTag_t {};

#if (defined(RTI_WIN32) || defined (RTI_WINCE)) && defined(NDDS_USER_DLL_EXPORT)
// On Windows, dll-export template instantiations of standard types used by
// other dll-exported types
template class NDDSUSERDllExport std::allocator<rti::core::uint64>;
template class NDDSUSERDllExport std::vector<rti::core::uint64 >;
#endif
typedef std::vector<rti::core::uint64> ubigintvec;
struct ubigintvec_AliasTag_t {};
...
class NDDSUSERDllExport DdsFloatmat {
  ...
  public:
    ...
    std::vector<float>& vec() OMG_NOEXCEPT; 
    const std::vector<float>& vec() const OMG_NOEXCEPT;
    void vec(const std::vector<float>& value);
...
class NDDSUSERDllExport DdsDoublemat {
  ...
  public:
    ...
    std::vector<double>& vec() OMG_NOEXCEPT; 
    const std::vector<double>& vec() const OMG_NOEXCEPT;
    void vec(const std::vector<double>& value);
...
namespace DdsJobMsdcAcqLwir {
    ...
    class NDDSUSERDllExport seqnoTGray16 {
      ...
      public:
        ...
        usmallintvec& gray16() OMG_NOEXCEPT; 
        const usmallintvec& gray16() const OMG_NOEXCEPT;
        void gray16(const usmallintvec& value);
...
namespace DdsJobMsdcAcqVisl {
    ...
    class NDDSUSERDllExport seqnoTRgbx8Gray8 {
      ...
      public:
        ...
        utinyintvec& rgbx8() OMG_NOEXCEPT; 
        const utinyintvec& rgbx8() const OMG_NOEXCEPT;
        void rgbx8(const utinyintvec& value);

        utinyintvec& gray8() OMG_NOEXCEPT; 
        const utinyintvec& gray8() const OMG_NOEXCEPT;
        void gray8(const utinyintvec& value);
      ...
      private:
        ...
        uint m_seqno_;
        double m_t_;
        utinyintvec m_rgbx8_;
        utinyintvec m_gray8_;
...
namespace DdsJobMsdcActAlign {
    ...
    class NDDSUSERDllExport setWave_req {
      ...
      public:
        ...
        floatvec& seq() OMG_NOEXCEPT; 
        const floatvec& seq() const OMG_NOEXCEPT;
        void seq(const floatvec& value);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type<utinyintvec_AliasTag_t> {
            typedef dds::core::xtypes::AliasType type;
            NDDSUSERDllExport static const dds::core::xtypes::AliasType& get();
        };

        template<>
        struct dynamic_type<usmallintvec_AliasTag_t> {
            typedef dds::core::xtypes::AliasType type;
            NDDSUSERDllExport static const dds::core::xtypes::AliasType& get();
        };

        template<>
        struct dynamic_type<intvec_AliasTag_t> {
            typedef dds::core::xtypes::AliasType type;
            NDDSUSERDllExport static const dds::core::xtypes::AliasType& get();
        };

        template<>
        struct dynamic_type<uintvec_AliasTag_t> {
            typedef dds::core::xtypes::AliasType type;
            NDDSUSERDllExport static const dds::core::xtypes::AliasType& get();
        };

        template<>
        struct dynamic_type<ubigintvec_AliasTag_t> {
            typedef dds::core::xtypes::AliasType type;
            NDDSUSERDllExport static const dds::core::xtypes::AliasType& get();
        };

        template<>
        struct dynamic_type<floatvec_AliasTag_t> {
            typedef dds::core::xtypes::AliasType type;
            NDDSUSERDllExport static const dds::core::xtypes::AliasType& get();
        };

        template<>
        struct dynamic_type<doublevec_AliasTag_t> {
            typedef dds::core::xtypes::AliasType type;
            NDDSUSERDllExport static const dds::core::xtypes::AliasType& get();
        };
