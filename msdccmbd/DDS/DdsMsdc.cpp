...
// --- Getters and Setters: -------------------------------------------------
std::vector<float>& DdsFloatmat::vec() OMG_NOEXCEPT {
    return m_vec_;
}

const std::vector<float>& DdsFloatmat::vec() const OMG_NOEXCEPT {
    return m_vec_;
}

void DdsFloatmat::vec(const std::vector<float>& value) {
    m_vec_ = value;
}
...
// --- Getters and Setters: -------------------------------------------------
std::vector<double>& DdsDoublemat::vec() OMG_NOEXCEPT {
    return m_vec_;
}

const std::vector<double>& DdsDoublemat::vec() const OMG_NOEXCEPT {
    return m_vec_;
}

void DdsDoublemat::vec(const std::vector<double>& value) {
    m_vec_ = value;
}
...
namespace DdsJobMsdcAcqLwir {
    ...
    setOutput_req::setOutput_req (
        ...
        :
            m_ixMsdcVSqrgrp_( ixMsdcVSqrgrp ) {
    }

    #ifdef RTI_CXX11_RVALUE_REFERENCES
    #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
    setOutput_req::setOutput_req(setOutput_req&& other_) OMG_NOEXCEPT  :m_ixMsdcVSqrgrp_ (std::move(other_.m_ixMsdcVSqrgrp_))
    {
    } 
    ...
    {
        using std::swap;
        swap(m_ixMsdcVSqrgrp_, other_.m_ixMsdcVSqrgrp_);
    }  

    bool setOutput_req::operator == (const setOutput_req& other_) const {
        if (m_ixMsdcVSqrgrp_ != other_.m_ixMsdcVSqrgrp_) {
            return false;
        }
        return true;
    }
    ...
    // --- Getters and Setters: -------------------------------------------------
    vecsref& DdsJobMsdcAcqLwir::setOutput_req::ixMsdcVSqrgrp() OMG_NOEXCEPT {
        return m_ixMsdcVSqrgrp_;
    }

    const vecsref& DdsJobMsdcAcqLwir::setOutput_req::ixMsdcVSqrgrp() const OMG_NOEXCEPT {
        return m_ixMsdcVSqrgrp_;
    }

    void DdsJobMsdcAcqLwir::setOutput_req::ixMsdcVSqrgrp(const vecsref& value) {
        m_ixMsdcVSqrgrp_ = value;
    }
    ...
    std::ostream& operator << (std::ostream& o,const setOutput_req& sample)
    {
        rti::util::StreamFlagSaver flag_saver (o);
        o <<"[";
        o << "ixMsdcVSqrgrp: " << sample.ixMsdcVSqrgrp() ;
        o <<"]";
        return o;
    }
    ...
    usmallintvec& DdsJobMsdcAcqLwir::seqnoTGray16::gray16() OMG_NOEXCEPT {
        return m_gray16_;
    }

    const usmallintvec& DdsJobMsdcAcqLwir::seqnoTGray16::gray16() const OMG_NOEXCEPT {
        return m_gray16_;
    }

    void DdsJobMsdcAcqLwir::seqnoTGray16::gray16(const usmallintvec& value) {
        m_gray16_ = value;
    }
...
namespace DdsJobMsdcAcqVisl {
    ...
    setOutput_req::setOutput_req (
        ...
        bool grayscale)
        :
            m_ixMsdcVCamres_( ixMsdcVCamres ),
            m_ixMsdcVSqrgrp_( ixMsdcVSqrgrp ),
    ...
    #ifdef RTI_CXX11_RVALUE_REFERENCES
    #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
    setOutput_req::setOutput_req(setOutput_req&& other_) OMG_NOEXCEPT  :m_ixMsdcVCamres_ (std::move(other_.m_ixMsdcVCamres_))
    ,
    m_ixMsdcVSqrgrp_ (std::move(other_.m_ixMsdcVSqrgrp_))
    ,
    ...
    {
        using std::swap;
        swap(m_ixMsdcVCamres_, other_.m_ixMsdcVCamres_);
        swap(m_ixMsdcVSqrgrp_, other_.m_ixMsdcVSqrgrp_);
        swap(m_grayscale_, other_.m_grayscale_);
    }  

    bool setOutput_req::operator == (const setOutput_req& other_) const {
        if (m_ixMsdcVCamres_ != other_.m_ixMsdcVCamres_) {
            return false;
        }
        if (m_ixMsdcVSqrgrp_ != other_.m_ixMsdcVSqrgrp_) {
            return false;
    ...
    // --- Getters and Setters: -------------------------------------------------
    vecsref& DdsJobMsdcAcqVisl::setOutput_req::ixMsdcVCamres() OMG_NOEXCEPT {
        return m_ixMsdcVCamres_;
    }

    const vecsref& DdsJobMsdcAcqVisl::setOutput_req::ixMsdcVCamres() const OMG_NOEXCEPT {
        return m_ixMsdcVCamres_;
    }

    void DdsJobMsdcAcqVisl::setOutput_req::ixMsdcVCamres(const vecsref& value) {
        m_ixMsdcVCamres_ = value;
    }

    vecsref& DdsJobMsdcAcqVisl::setOutput_req::ixMsdcVSqrgrp() OMG_NOEXCEPT {
        return m_ixMsdcVSqrgrp_;
    }

    const vecsref& DdsJobMsdcAcqVisl::setOutput_req::ixMsdcVSqrgrp() const OMG_NOEXCEPT {
        return m_ixMsdcVSqrgrp_;
    }

    void DdsJobMsdcAcqVisl::setOutput_req::ixMsdcVSqrgrp(const vecsref& value) {
        m_ixMsdcVSqrgrp_ = value;
    }
    ...
    std::ostream& operator << (std::ostream& o,const setOutput_req& sample)
    {
        rti::util::StreamFlagSaver flag_saver (o);
        o <<"[";
        o << "ixMsdcVCamres: " << sample.ixMsdcVCamres()<<", ";
        o << "ixMsdcVSqrgrp: " << sample.ixMsdcVSqrgrp()<<", ";
    ...
    seqnoTRgbx8Gray8::seqnoTRgbx8Gray8 (
        const uint& seqno,
        double t,
        const utinyintvec& rgbx8,
        const utinyintvec& gray8)
        :
            m_seqno_( seqno ),
            m_t_( t ),
            m_rgbx8_( rgbx8 ),
    ...
    utinyintvec& DdsJobMsdcAcqVisl::seqnoTRgbx8Gray8::rgbx8() OMG_NOEXCEPT {
        return m_rgbx8_;
    }

    const utinyintvec& DdsJobMsdcAcqVisl::seqnoTRgbx8Gray8::rgbx8() const OMG_NOEXCEPT {
        return m_rgbx8_;
    }

    void DdsJobMsdcAcqVisl::seqnoTRgbx8Gray8::rgbx8(const utinyintvec& value) {
        m_rgbx8_ = value;
    }

    utinyintvec& DdsJobMsdcAcqVisl::seqnoTRgbx8Gray8::gray8() OMG_NOEXCEPT {
        return m_gray8_;
    }

    const utinyintvec& DdsJobMsdcAcqVisl::seqnoTRgbx8Gray8::gray8() const OMG_NOEXCEPT {
        return m_gray8_;
    }

    void DdsJobMsdcAcqVisl::seqnoTRgbx8Gray8::gray8(const utinyintvec& value) {
        m_gray8_ = value;
    }
...
namespace DdsJobMsdcAcqVisr {
    ...
    // --- Getters and Setters: -------------------------------------------------
    vecsref& DdsJobMsdcAcqVisr::setOutput_req::ixMsdcVCamres() OMG_NOEXCEPT {
        return m_ixMsdcVCamres_;
    }

    const vecsref& DdsJobMsdcAcqVisr::setOutput_req::ixMsdcVCamres() const OMG_NOEXCEPT {
        return m_ixMsdcVCamres_;
    }

    void DdsJobMsdcAcqVisr::setOutput_req::ixMsdcVCamres(const vecsref& value) {
        m_ixMsdcVCamres_ = value;
    }

    vecsref& DdsJobMsdcAcqVisr::setOutput_req::ixMsdcVSqrgrp() OMG_NOEXCEPT {
        return m_ixMsdcVSqrgrp_;
    }

    const vecsref& DdsJobMsdcAcqVisr::setOutput_req::ixMsdcVSqrgrp() const OMG_NOEXCEPT {
        return m_ixMsdcVSqrgrp_;
    }

    void DdsJobMsdcAcqVisr::setOutput_req::ixMsdcVSqrgrp(const vecsref& value) {
        m_ixMsdcVSqrgrp_ = value;
    }
    ...
    utinyintvec& DdsJobMsdcAcqVisr::seqnoTRgbx8Gray8::rgbx8() OMG_NOEXCEPT {
        return m_rgbx8_;
    }

    const utinyintvec& DdsJobMsdcAcqVisr::seqnoTRgbx8Gray8::rgbx8() const OMG_NOEXCEPT {
        return m_rgbx8_;
    }

    void DdsJobMsdcAcqVisr::seqnoTRgbx8Gray8::rgbx8(const utinyintvec& value) {
        m_rgbx8_ = value;
    }

    utinyintvec& DdsJobMsdcAcqVisr::seqnoTRgbx8Gray8::gray8() OMG_NOEXCEPT {
        return m_gray8_;
    }

    const utinyintvec& DdsJobMsdcAcqVisr::seqnoTRgbx8Gray8::gray8() const OMG_NOEXCEPT {
        return m_gray8_;
    }

    void DdsJobMsdcAcqVisr::seqnoTRgbx8Gray8::gray8(const utinyintvec& value) {
        m_gray8_ = value;
    }
...
namespace DdsJobMsdcActAlign {
    ...
    #ifdef RTI_CXX11_RVALUE_REFERENCES
    #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
    setWave_req::setWave_req(setWave_req&& other_) OMG_NOEXCEPT  :m_ixVFunction_ (std::move(other_.m_ixVFunction_))
    ,
    m_N_ (std::move(other_.m_N_))
    ,
    ...
    // --- Getters and Setters: -------------------------------------------------
    vecsref& DdsJobMsdcActAlign::setWave_req::ixVFunction() OMG_NOEXCEPT {
        return m_ixVFunction_;
    }

    const vecsref& DdsJobMsdcActAlign::setWave_req::ixVFunction() const OMG_NOEXCEPT {
        return m_ixVFunction_;
    }

    void DdsJobMsdcActAlign::setWave_req::ixVFunction(const vecsref& value) {
        m_ixVFunction_ = value;
    }
    ...
    floatvec& DdsJobMsdcActAlign::setWave_req::seq() OMG_NOEXCEPT {
        return m_seq_;
    }

    const floatvec& DdsJobMsdcActAlign::setWave_req::seq() const OMG_NOEXCEPT {
        return m_seq_;
    }

    void DdsJobMsdcActAlign::setWave_req::seq(const floatvec& value) {
        m_seq_ = value;
    }
    ...
    std::ostream& operator << (std::ostream& o,const setWave_req& sample)
    {
        rti::util::StreamFlagSaver flag_saver (o);
        o <<"[";
        o << "ixVFunction: " << sample.ixVFunction()<<", ";
        o << "N: " << sample.N()<<", ";
        o << "seq: " << sample.seq() ;
        o <<"]";
        return o;
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct native_type_code<utinyintvec_AliasTag_t> {
            static DDS_TypeCode * get()
            {
                static RTIBool is_initialized = RTI_FALSE;

                static DDS_TypeCode utinyintvec_g_tc_sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);

                static DDS_TypeCode utinyintvec_g_tc =
                {{
                        DDS_TK_ALIAS, /* Kind*/
                        DDS_BOOLEAN_FALSE,/* Is a pointer? */
                        -1, /* Ignored */
                        (char *)"utinyintvec", /* Name */
                        NULL, /* Content type code is assigned later */
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                        ...
                        NULL, /* Ignored */
                        DDS_VM_NONE /* Ignored */
                    }}; /* Type code for  utinyintvec */

                if (is_initialized) {
                    return &utinyintvec_g_tc;
                }

                utinyintvec_g_tc_sequence._data._typeCode = (RTICdrTypeCode *)&DDS_g_tc_octet;

                utinyintvec_g_tc._data._typeCode =  (RTICdrTypeCode *)& utinyintvec_g_tc_sequence;
        ...
        const dds::core::xtypes::AliasType& dynamic_type<utinyintvec_AliasTag_t>::get()
        {
            return static_cast<const dds::core::xtypes::AliasType&>(
                rti::core::native_conversions::cast_from_native<dds::core::xtypes::DynamicType>(
                    *(native_type_code<utinyintvec_AliasTag_t>::get())));
        }

        template<>
        struct native_type_code<usmallintvec_AliasTag_t> {
            static DDS_TypeCode * get()
            {
                static RTIBool is_initialized = RTI_FALSE;

                static DDS_TypeCode usmallintvec_g_tc_sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);

                static DDS_TypeCode usmallintvec_g_tc =
                {{
                        DDS_TK_ALIAS, /* Kind*/
                        DDS_BOOLEAN_FALSE,/* Is a pointer? */
                        -1, /* Ignored */
                        (char *)"usmallintvec", /* Name */
                        NULL, /* Content type code is assigned later */
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                        ...
                        NULL, /* Ignored */
                        DDS_VM_NONE /* Ignored */
                    }}; /* Type code for  usmallintvec */

                if (is_initialized) {
                    return &usmallintvec_g_tc;
                }

                usmallintvec_g_tc_sequence._data._typeCode = (RTICdrTypeCode *)&DDS_g_tc_ushort;

                usmallintvec_g_tc._data._typeCode =  (RTICdrTypeCode *)& usmallintvec_g_tc_sequence;
        ...
        const dds::core::xtypes::AliasType& dynamic_type<usmallintvec_AliasTag_t>::get()
        {
            return static_cast<const dds::core::xtypes::AliasType&>(
                rti::core::native_conversions::cast_from_native<dds::core::xtypes::DynamicType>(
                    *(native_type_code<usmallintvec_AliasTag_t>::get())));
        }

        template<>
        struct native_type_code<intvec_AliasTag_t> {
            static DDS_TypeCode * get()
            {
                static RTIBool is_initialized = RTI_FALSE;

                static DDS_TypeCode intvec_g_tc_sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);

                static DDS_TypeCode intvec_g_tc =
                {{
                        DDS_TK_ALIAS, /* Kind*/
                        DDS_BOOLEAN_FALSE,/* Is a pointer? */
                        -1, /* Ignored */
                        ...
                        NULL, /* Ignored */
                        DDS_VM_NONE /* Ignored */
                    }}; /* Type code for  intvec */

                if (is_initialized) {
                    return &intvec_g_tc;
                }

                intvec_g_tc_sequence._data._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;

                intvec_g_tc._data._typeCode =  (RTICdrTypeCode *)& intvec_g_tc_sequence;
        ...
        const dds::core::xtypes::AliasType& dynamic_type<intvec_AliasTag_t>::get()
        {
            return static_cast<const dds::core::xtypes::AliasType&>(
                rti::core::native_conversions::cast_from_native<dds::core::xtypes::DynamicType>(
                    *(native_type_code<intvec_AliasTag_t>::get())));
        }

        template<>
        struct native_type_code<uintvec_AliasTag_t> {
            static DDS_TypeCode * get()
            {
                static RTIBool is_initialized = RTI_FALSE;

                static DDS_TypeCode uintvec_g_tc_sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);

                static DDS_TypeCode uintvec_g_tc =
                {{
                        DDS_TK_ALIAS, /* Kind*/
                        DDS_BOOLEAN_FALSE,/* Is a pointer? */
                        -1, /* Ignored */
                        ...
                        NULL, /* Ignored */
                        DDS_VM_NONE /* Ignored */
                    }}; /* Type code for  uintvec */

                if (is_initialized) {
                    return &uintvec_g_tc;
                }

                uintvec_g_tc_sequence._data._typeCode = (RTICdrTypeCode *)&DDS_g_tc_ulong;

                uintvec_g_tc._data._typeCode =  (RTICdrTypeCode *)& uintvec_g_tc_sequence;
        ...
        const dds::core::xtypes::AliasType& dynamic_type<uintvec_AliasTag_t>::get()
        {
            return static_cast<const dds::core::xtypes::AliasType&>(
                rti::core::native_conversions::cast_from_native<dds::core::xtypes::DynamicType>(
                    *(native_type_code<uintvec_AliasTag_t>::get())));
        }

        template<>
        struct native_type_code<ubigintvec_AliasTag_t> {
            static DDS_TypeCode * get()
            {
                static RTIBool is_initialized = RTI_FALSE;

                static DDS_TypeCode ubigintvec_g_tc_sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);

                static DDS_TypeCode ubigintvec_g_tc =
                {{
                        DDS_TK_ALIAS, /* Kind*/
                        DDS_BOOLEAN_FALSE,/* Is a pointer? */
                        -1, /* Ignored */
                        (char *)"ubigintvec", /* Name */
                        NULL, /* Content type code is assigned later */
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                        ...
                        NULL, /* Ignored */
                        DDS_VM_NONE /* Ignored */
                    }}; /* Type code for  ubigintvec */

                if (is_initialized) {
                    return &ubigintvec_g_tc;
                }

                ubigintvec_g_tc_sequence._data._typeCode = (RTICdrTypeCode *)&DDS_g_tc_ulonglong;

                ubigintvec_g_tc._data._typeCode =  (RTICdrTypeCode *)& ubigintvec_g_tc_sequence;
        ...
        const dds::core::xtypes::AliasType& dynamic_type<ubigintvec_AliasTag_t>::get()
        {
            return static_cast<const dds::core::xtypes::AliasType&>(
                rti::core::native_conversions::cast_from_native<dds::core::xtypes::DynamicType>(
                    *(native_type_code<ubigintvec_AliasTag_t>::get())));
        }

        template<>
        struct native_type_code<floatvec_AliasTag_t> {
            static DDS_TypeCode * get()
            {
                static RTIBool is_initialized = RTI_FALSE;

                static DDS_TypeCode floatvec_g_tc_sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);

                static DDS_TypeCode floatvec_g_tc =
                {{
                        DDS_TK_ALIAS, /* Kind*/
                        DDS_BOOLEAN_FALSE,/* Is a pointer? */
                        -1, /* Ignored */
                        ...
                        NULL, /* Ignored */
                        DDS_VM_NONE /* Ignored */
                    }}; /* Type code for  floatvec */

                if (is_initialized) {
                    return &floatvec_g_tc;
                }

                floatvec_g_tc_sequence._data._typeCode = (RTICdrTypeCode *)&DDS_g_tc_float;

                floatvec_g_tc._data._typeCode =  (RTICdrTypeCode *)& floatvec_g_tc_sequence;
        ...
        const dds::core::xtypes::AliasType& dynamic_type<floatvec_AliasTag_t>::get()
        {
            return static_cast<const dds::core::xtypes::AliasType&>(
                rti::core::native_conversions::cast_from_native<dds::core::xtypes::DynamicType>(
                    *(native_type_code<floatvec_AliasTag_t>::get())));
        }

        template<>
        struct native_type_code<doublevec_AliasTag_t> {
            static DDS_TypeCode * get()
            {
                static RTIBool is_initialized = RTI_FALSE;

                static DDS_TypeCode doublevec_g_tc_sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);

                static DDS_TypeCode doublevec_g_tc =
                {{
                        DDS_TK_ALIAS, /* Kind*/
                        DDS_BOOLEAN_FALSE,/* Is a pointer? */
                        -1, /* Ignored */
                        ...
                        NULL, /* Ignored */
                        DDS_VM_NONE /* Ignored */
                    }}; /* Type code for  doublevec */

                if (is_initialized) {
                    return &doublevec_g_tc;
                }

                doublevec_g_tc_sequence._data._typeCode = (RTICdrTypeCode *)&DDS_g_tc_double;

                doublevec_g_tc._data._typeCode =  (RTICdrTypeCode *)& doublevec_g_tc_sequence;
        ...
        const dds::core::xtypes::AliasType& dynamic_type<doublevec_AliasTag_t>::get()
        {
            return static_cast<const dds::core::xtypes::AliasType&>(
                rti::core::native_conversions::cast_from_native<dds::core::xtypes::DynamicType>(
                    *(native_type_code<doublevec_AliasTag_t>::get())));
        }
        ...
        struct native_type_code<DdsFloatmat> {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode DdsFloatmat_g_tc_vec_sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);
        ...
        struct native_type_code<DdsDoublemat> {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode DdsDoublemat_g_tc_vec_sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);
        ...
        struct native_type_code<stringvec_AliasTag_t> {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode stringvec_g_tc_string = DDS_INITIALIZE_STRING_TYPECODE(RTI_INT32_MAX);
                static DDS_TypeCode stringvec_g_tc_sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);
                ...
                stringvec_g_tc_sequence._data._typeCode = (RTICdrTypeCode *)&stringvec_g_tc_string;

                stringvec_g_tc._data._typeCode =  (RTICdrTypeCode *)& stringvec_g_tc_sequence;
        ...
        struct native_type_code<vecsref_AliasTag_t> {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode vecsref_g_tc_string = DDS_INITIALIZE_STRING_TYPECODE(RTI_INT32_MAX);
        ...
        struct native_type_code<DdsJobMsdcAcqLwir::setOutput_req> {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member setOutput_req_g_tc_members[1]=
                {
                    ...
                    {
                        (char *)"ixMsdcVSqrgrp",/* Member name */
                        {
                            0,/* Representation ID */          
                            DDS_BOOLEAN_FALSE,/* Is a pointer? */
                            -1, /* Bitfield bits */
        ...
        struct native_type_code<DdsJobMsdcAcqLwir::seqnoTGray16> {
            static DDS_TypeCode * get()
            {
                ...
                seqnoTGray16_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&rti::topic::dynamic_type<usmallintvec_AliasTag_t>::get().native();
        ...
        struct native_type_code<DdsJobMsdcAcqVisl::setOutput_req> {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member setOutput_req_g_tc_members[3]=
                {
                    ...
                    {
                        (char *)"ixMsdcVCamres",/* Member name */
                        {
                            0,/* Representation ID */          
                            DDS_BOOLEAN_FALSE,/* Is a pointer? */
                            -1, /* Bitfield bits */
        ...
        struct native_type_code<DdsJobMsdcAcqVisl::seqnoTRgbx8Gray8> {
            static DDS_TypeCode * get()
            {
                ...
                seqnoTRgbx8Gray8_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&rti::topic::dynamic_type<utinyintvec_AliasTag_t>::get().native();

                seqnoTRgbx8Gray8_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&rti::topic::dynamic_type<utinyintvec_AliasTag_t>::get().native();
        ...
        struct native_type_code<DdsJobMsdcActAlign::setWave_req> {
            static DDS_TypeCode * get()
            {
                ...
                setWave_req_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&rti::topic::dynamic_type<floatvec_AliasTag_t>::get().native();
...
namespace dds { 
    namespace topic {
        ...
        {
            rti::topic::allocate_sample(sample.vec(),  -1, -1);
        ...
        void topic_type_support<DdsJobMsdcAcqLwir::seqnoTGray16>::allocate_sample(DdsJobMsdcAcqLwir::seqnoTGray16& sample, int, int) 
        {
            ...
            rti::topic::allocate_sample(sample.gray16(),  -1, -1);
        }
        ...
        {
            rti::topic::reset_sample(sample.ixMsdcVCamres());
            rti::topic::reset_sample(sample.ixMsdcVSqrgrp());
        ...
        {
            rti::topic::allocate_sample(sample.ixMsdcVCamres(),  -1, -1);
            rti::topic::allocate_sample(sample.ixMsdcVSqrgrp(),  -1, -1);
        }
        ...
        {
            rti::topic::allocate_sample(sample.seqno(),  -1, -1);
            rti::topic::allocate_sample(sample.rgbx8(),  -1, -1);
            rti::topic::allocate_sample(sample.gray8(),  -1, -1);
        }
        ...
        {
            rti::topic::reset_sample(sample.ixVFunction());
            rti::topic::reset_sample(sample.N());
        ...
        {
            rti::topic::allocate_sample(sample.ixVFunction(),  -1, -1);
            rti::topic::allocate_sample(sample.N(),  -1, -1);
            rti::topic::allocate_sample(sample.seq(),  -1, -1);
        }
