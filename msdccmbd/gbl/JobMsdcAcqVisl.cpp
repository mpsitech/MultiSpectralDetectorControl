/**
  ...
  * job handler for job JobMsdcAcqVisl (implementation)
...
#include "JobMsdcAcqVisl_blks.cpp"

// IP Shrdat.subs --- INSERT

/******************************************************************************
 class JobMsdcAcqVisl::Shrdat
 ******************************************************************************/

JobMsdcAcqVisl::Shrdat::Shrdat() : ShrdatMsdc("JobMsdcAcqVisl", "Shrdat", "JobMsdcAcqVisl::shrdat") {
};

void JobMsdcAcqVisl::Shrdat::init(
			XchgMsdc* xchg
			, DbsMsdc* dbsmsdc
		) {
...
void JobMsdcAcqVisl::Shrdat::term() {
...
/******************************************************************************
 class JobMsdcAcqVisl
 ******************************************************************************/

JobMsdcAcqVisl::JobMsdcAcqVisl(
			XchgMsdc* xchg
			, DbsMsdc* dbsmsdc
			, const ubigint jrefSup
			, const uint ixMsdcVLocale
			, const bool prefmast
		) : MsjobMsdc(xchg, VecMsdcVJob::JOBMSDCACQVISL, jrefSup, ixMsdcVLocale, prefmast) {
...
// IP cust --- IBEGIN
void JobMsdcAcqVisl::changeCamtype(
	...
	if (getMastNotSlv()) {
		...
		JobMsdcAcqVisl* master = (JobMsdcAcqVisl*) lockMaster("changeCamtype");
...
void JobMsdcAcqVisl::changeSqrgrp(
	...
	if (getMastNotSlv()) {
		...
		JobMsdcAcqVisl* master = (JobMsdcAcqVisl*) lockMaster("changeSqrgrp");
...
bool JobMsdcAcqVisl::openBlackfly() {
#ifdef __linux__
	CameraList camList;
...
bool JobMsdcAcqVisl::openBlackfly_setNodeEnum(
			INodeMap& nodeMap
			, const string& key
			, const string& value
		) {
...
bool JobMsdcAcqVisl::openBlackfly_setNodeInteger(
			INodeMap& nodeMap
			, const string& key
			, const int value
		) {
...
bool JobMsdcAcqVisl::openBlackfly_setNodeFloat(
			INodeMap& nodeMap
			, const string& key
			, const float value
		) {
...
void JobMsdcAcqVisl::closeBlackfly() {
#ifdef __linux__
...
vector<string> JobMsdcAcqVisl::surveyBlackfly() {
...
bool JobMsdcAcqVisl::openLifecam() {
#ifdef __linux__
	bool valid;
...
bool JobMsdcAcqVisl::openLifecam_setCtrl(
			const int id
			, const string& sref
...
void JobMsdcAcqVisl::closeLifecam() {
#ifdef __linux__
	if (shrdat.cammmap) {
		munmap(shrdat.cammmap, shrdat.buf.length);
		shrdat.buf = {};
...
vector<string> JobMsdcAcqVisl::surveyLifecam() {
	vector<string> paths;
...
inline unsigned int JobMsdcAcqVisl::intavg(
...
bool JobMsdcAcqVisl::setFocus(
	...
	if (getMastNotSlv()) {
		...
		JobMsdcAcqVisl* master = (JobMsdcAcqVisl*) lockMaster("setFocus");
...
bool JobMsdcAcqVisl::setTint(
	...
	if (getMastNotSlv()) {
		...
		JobMsdcAcqVisl* master = (JobMsdcAcqVisl*) lockMaster("setTint");
...
void JobMsdcAcqVisl::changeStage(
			DbsMsdc* dbsmsdc
			, uint _ixVSge
		) {
	bool reenter = true;
...
uint JobMsdcAcqVisl::enterSgeIdle(
			DbsMsdc* dbsmsdc
			, const bool reenter
		) {
...
void JobMsdcAcqVisl::leaveSgeIdle(
			DbsMsdc* dbsmsdc
		) {
...
uint JobMsdcAcqVisl::enterSgeReady(
			DbsMsdc* dbsmsdc
			, const bool reenter
		) {
...
void JobMsdcAcqVisl::leaveSgeReady(
			DbsMsdc* dbsmsdc
		) {
	// IP leaveSgeReady --- INSERT
};

uint JobMsdcAcqVisl::enterSgeAcqidle(
			DbsMsdc* dbsmsdc
			, const bool reenter
		) {
...
void JobMsdcAcqVisl::leaveSgeAcqidle(
			DbsMsdc* dbsmsdc
		) {
	// IP leaveSgeAcqidle --- INSERT
};

uint JobMsdcAcqVisl::enterSgeAcq(
			DbsMsdc* dbsmsdc
			, const bool reenter
		) {
...
void JobMsdcAcqVisl::leaveSgeAcq(
			DbsMsdc* dbsmsdc
		) {
	// IP leaveSgeAcq --- INSERT
};

uint JobMsdcAcqVisl::enterSgePrcidle(
			DbsMsdc* dbsmsdc
			, const bool reenter
		) {
...
void JobMsdcAcqVisl::leaveSgePrcidle(
			DbsMsdc* dbsmsdc
		) {
	// IP leaveSgePrcidle --- INSERT
};

uint JobMsdcAcqVisl::enterSgePrc(
			DbsMsdc* dbsmsdc
			, const bool reenter
		) {
...
void JobMsdcAcqVisl::leaveSgePrc(
			DbsMsdc* dbsmsdc
		) {
	// IP leaveSgePrc --- INSERT
};

string JobMsdcAcqVisl::getSquawk(
			DbsMsdc* dbsmsdc
		) {
	string retval;
	// IP getSquawk --- BEGIN
...
void JobMsdcAcqVisl::giveupMaster(
			DbsMsdc* dbsmsdc
			, Msjobinfo* msji
		) {
...
void JobMsdcAcqVisl::giveupSlave(
			DbsMsdc* dbsmsdc
			, Msjobinfo* msji
		) {
...
void JobMsdcAcqVisl::becomeMaster(
			DbsMsdc* dbsmsdc
			, Msjobinfo* msji
		) {
...
void JobMsdcAcqVisl::becomeSlave(
			DbsMsdc* dbsmsdc
			, Msjobinfo* msji
		) {
...
bool JobMsdcAcqVisl::handleClaimMaster(
			DbsMsdc* dbsmsdc
			, Msjobinfo* msji
		) {
...
void JobMsdcAcqVisl::handleRequest(
			DbsMsdc* dbsmsdc
			, ReqMsdc* req
		) {
	if (req->ixVBasetype == ReqMsdc::VecVBasetype::CMD) {
		...
		if (req->cmd == "cmdset") {
			cout << "\ttestBlackfly" << endl;
			cout << "\ttestLifecam" << endl;
		} else if (req->cmd == "testBlackfly") {
			req->retain = handleTestBlackfly(dbsmsdc);

		} else if (req->cmd == "testLifecam") {
			req->retain = handleTestLifecam(dbsmsdc);
	...
	} else if ((req->ixVBasetype == ReqMsdc::VecVBasetype::METHOD) && (req->method->ixVFeatgroup == VecMsdcVFeatgroup::VECVJOBMSDCACQVISLMETHOD)) {
...
bool JobMsdcAcqVisl::handleTestBlackfly(
			DbsMsdc* dbsmsdc
		) {
	bool retval = false;
	// IP handleTestBlackfly --- IBEGIN
#ifdef __linux__
//	SystemPtr system = System::GetInstance();

	CameraList camList = xchg->shrdatJobprc.spinsys->GetCameras();
	CameraPtr cam = camList.GetBySerial(stg.serno);
	camList.Clear();

	cam->Init();

	INodeMap& nodeMapTLD = cam->GetTLDeviceNodeMap();
	...
	CCategoryPtr category;

	CEnumerationPtr acquisitionMode;
	CEnumEntryPtr acquisitionModeContinuous;
	...
	category = nodeMapTLD.GetNode("DeviceInformation");
	...
	if (IsAvailable(category) && IsReadable(category)) {
		...
		for (auto it=features.begin();it!=features.end();it++) {
			...
			if (IsReadable(value)) cout << feature->GetName() << ": " << value->ToString() << endl;
		};
	};

	// -- acquire ten frames
	acquisitionMode = nodeMap.GetNode("AcquisitionMode");
	valid = (IsAvailable(acquisitionMode) && IsWritable(acquisitionMode));

	if (valid) {
		acquisitionModeContinuous = acquisitionMode->GetEntryByName("Continuous");
		valid = (IsAvailable(acquisitionModeContinuous) && IsReadable(acquisitionModeContinuous));

		if (valid) acquisitionMode->SetIntValue(acquisitionModeContinuous->GetValue());
	};

	if (valid) {
		// cf. GigEConfig.cpp
		// reduce bandwidth requirement
		GevSCPD = nodeMap.GetNode("GevSCPD");
		valid = (IsAvailable(GevSCPD) && IsWritable(GevSCPD));

		if (valid) GevSCPD->SetValue(10000);
	};
	...
	if (valid) {
		...
		for (unsigned int i=0;i<10;i++) {
			resultImage = cam->GetNextImage();

			if (!resultImage->IsIncomplete()) {
				cout << "\timage #" << (i+1) << ": buffer size=" << resultImage->GetBufferSize()
							<< ", width=" << resultImage->GetWidth()
							<< ", height=" << resultImage->GetHeight() << endl;

				convertedImage = resultImage->Convert(PixelFormat_Mono8, HQ_LINEAR);

				s = "./img" + stg.serno + "-" + to_string(i) + ".jpg";

				convertedImage->Save(s.c_str());
			};
...
//	system->ReleaseInstance();
#endif
	// IP handleTestBlackfly --- IEND
	return retval;
};

bool JobMsdcAcqVisl::handleTestLifecam(
			DbsMsdc* dbsmsdc
		) {
	bool retval = false;
	...
	size_t sizeRgbbuf = 3*1280*720;
	unsigned char* rgbbuf = new unsigned char[sizeRgbbuf];

	unsigned char** rowptr;
	rowptr = new unsigned char*[720];

	for (int i=0;i<720;i++) rowptr[i] = &(rgbbuf[3*1280*(720-i-1)]);
		...
		for (unsigned int i=0;i<10;i++) {
			...
			while (true) {
				...
				if (valid) {
					...
					jpeg_mem_src(&cinfo, (unsigned char*) cammmap, buf.bytesused);

					valid = (jpeg_read_header(&cinfo, true) == 1);
					if (!valid) {
						cout << "\tno valid JPEG header was detected" << endl;
						break;
					};
					...
					cout << "\tdetected JPEG parameters: output_width=" << cinfo.output_width << ", output_height=" << cinfo.output_height << ", output_components=" << cinfo.output_components << endl;

					valid = ((cinfo.output_width == 1280) && (cinfo.output_height == 720) && (cinfo.output_components == 3));
					if (!valid) {
						cout << "\twrong JPEG frame size" << endl;
						break;
					};
					...
					for (unsigned int i=0;i<720;i++) {
						valid = (jpeg_read_scanlines(&cinfo, &(rowptr[i]), 1) == 1);
...
void JobMsdcAcqVisl::handleTimer(
			DbsMsdc* dbsmsdc
			, const string& sref
		) {
...
void JobMsdcAcqVisl::handleCall(
			DbsMsdc* dbsmsdc
			, Call* call
		) {
...
bool JobMsdcAcqVisl::handleCallMsdcIbitrdy(
			DbsMsdc* dbsmsdc
...
bool JobMsdcAcqVisl::handleCallMsdcTrig(
			DbsMsdc* dbsmsdc
			, const ubigint jrefTrig
			, const int intvalInv
		) {
...
bool JobMsdcAcqVisl::handleCallMsdcMastsrdChg(
			DbsMsdc* dbsmsdc
			, const ubigint jrefTrig
