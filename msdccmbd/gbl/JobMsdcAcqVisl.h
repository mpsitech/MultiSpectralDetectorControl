...
#define VecVJobMsdcAcqVislMethod JobMsdcAcqVisl::VecVMethod
#define VecVJobMsdcAcqVislSge JobMsdcAcqVisl::VecVSge
#define VecVJobMsdcAcqVislVar JobMsdcAcqVisl::VecVVar

#define StgJobMsdcAcqVisl JobMsdcAcqVisl::Stg

#define ShrdatJobMsdcAcqVisl JobMsdcAcqVisl::Shrdat

/**
  * JobMsdcAcqVisl
  */
class JobMsdcAcqVisl : public MsjobMsdc {
...
public:
	...
	/**
		* Shrdat (full: ShrdatJobMsdcAcqVisl)
		*/
...
public:
	JobMsdcAcqVisl(XchgMsdc* xchg, DbsMsdc* dbsmsdc, const ubigint jrefSup, const uint ixMsdcVLocale, const bool prefmast);
	~JobMsdcAcqVisl();
...
public:
	...
	bool handleTestBlackfly(DbsMsdc* dbsmsdc);
	bool handleTestLifecam(DbsMsdc* dbsmsdc);
