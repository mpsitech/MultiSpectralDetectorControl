/**
  * \file PnlMsdcUsrMNUsergroup.java
  * Java API code for job PnlMsdcUsrMNUsergroup
...
public class PnlMsdcUsrMNUsergroup {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfMsdcUsrMNUsergroup");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppMsdcUsrMNUsergroup");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrMsdcUsrMNUsergroup");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacMsdcUsrMNUsergroup");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacMsdcUsrMNUsergroup";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagMsdcUsrMNUsergroup");
	...
	public class DpchAppData extends DpchAppMsdc {
		...
		public DpchAppData(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCUSRMNUSERGROUPDATA, scrJref);
		...
		public QryMsdcUsrMNUsergroup.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcUsrMNUsergroupData");
	...
	public class DpchAppDo extends DpchAppMsdc {
		...
		public DpchAppDo(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCUSRMNUSERGROUPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcUsrMNUsergroupDo");
	...
	public class DpchEngData extends DpchEngMsdc {
		...
		public DpchEngData() {
			super(VecMsdcVDpch.DPCHENGMSDCUSRMNUSERGROUPDATA);
			...
			tag = new Tag("", "", "", "", "", "");
			rst = new ListMsdcQUsrMNUsergroup();
			statappqry = (new QryMsdcUsrMNUsergroup()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryMsdcUsrMNUsergroup()).new StatShr(0, 0, 0);
			stgiacqry = (new QryMsdcUsrMNUsergroup()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListMsdcQUsrMNUsergroup rst;
		public QryMsdcUsrMNUsergroup.StatApp statappqry;
		public QryMsdcUsrMNUsergroup.StatShr statshrqry;
		public QryMsdcUsrMNUsergroup.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngMsdcUsrMNUsergroupData");
