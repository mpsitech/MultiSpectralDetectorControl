/**
  * \file QryMsdcDatAPar.java
  * Java API code for job QryMsdcDatAPar
...
public class QryMsdcDatAPar {
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryMsdcDatAPar");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryMsdcDatAPar");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryMsdcDatAPar");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryMsdcDatAPar";
