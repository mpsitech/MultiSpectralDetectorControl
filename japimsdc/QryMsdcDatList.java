/**
  * \file QryMsdcDatList.java
  * Java API code for job QryMsdcDatList
...
public class QryMsdcDatList {
	...
	public static class VecVOrd {
		...
		public static int getIx(
			...
			if (s.equals("aft")) return AFT;
			if (s.equals("prd")) return PRD;
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryMsdcDatList");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryMsdcDatList");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryMsdcDatList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryMsdcDatList";
