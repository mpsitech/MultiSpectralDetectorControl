/**
  * \file PnlMsdcUsgAAccess.java
  * Java API code for job PnlMsdcUsgAAccess
...
public class PnlMsdcUsgAAccess {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfMsdcUsgAAccess");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppMsdcUsgAAccess");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrMsdcUsgAAccess");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacMsdcUsgAAccess");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacMsdcUsgAAccess";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagMsdcUsgAAccess");
	...
	public class DpchAppData extends DpchAppMsdc {
		...
		public DpchAppData(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCUSGAACCESSDATA, scrJref);
		...
		public QryMsdcUsgAAccess.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcUsgAAccessData");
	...
	public class DpchAppDo extends DpchAppMsdc {
		...
		public DpchAppDo(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCUSGAACCESSDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcUsgAAccessDo");
	...
	public class DpchEngData extends DpchEngMsdc {
		...
		public DpchEngData() {
			super(VecMsdcVDpch.DPCHENGMSDCUSGAACCESSDATA);
			...
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListMsdcQUsgAAccess();
			statappqry = (new QryMsdcUsgAAccess()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryMsdcUsgAAccess()).new StatShr(0, 0, 0);
			stgiacqry = (new QryMsdcUsgAAccess()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListMsdcQUsgAAccess rst;
		public QryMsdcUsgAAccess.StatApp statappqry;
		public QryMsdcUsgAAccess.StatShr statshrqry;
		public QryMsdcUsgAAccess.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngMsdcUsgAAccessData");
