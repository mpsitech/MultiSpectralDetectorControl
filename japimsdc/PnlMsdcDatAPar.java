/**
  * \file PnlMsdcDatAPar.java
  * Java API code for job PnlMsdcDatAPar
...
public class PnlMsdcDatAPar {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfMsdcDatAPar");

			String itemtag = "ContitemInfMsdcDatAPar";
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppMsdcDatAPar");

			String itemtag = "StatitemAppMsdcDatAPar";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrMsdcDatAPar");

			String itemtag = "StatitemShrMsdcDatAPar";
	...
	public class StgIac extends Block {
		...
		public static final int TCOSTAWIDTH = 1;
		public static final int TCOKEYWIDTH = 2;
		public static final int TCOFILWIDTH = 3;
		public static final int TCOVALWIDTH = 4;
		public static final int TCOBINWIDTH = 5;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSTAWIDTH, TCOKEYWIDTH, TCOFILWIDTH, TCOVALWIDTH, TCOBINWIDTH));
		};

		public int TcoStaWidth;
		public int TcoKeyWidth;
		public int TcoFilWidth;
		public int TcoValWidth;
		public int TcoBinWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacMsdcDatAPar");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoFilWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoFilWidth", mask, TCOFILWIDTH);
				TcoValWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoValWidth", mask, TCOVALWIDTH);
				TcoBinWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoBinWidth", mask, TCOBINWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacMsdcDatAPar";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoFilWidth", TcoFilWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoValWidth", TcoValWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoBinWidth", TcoBinWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoFilWidth == comp.TcoFilWidth) items.add(TCOFILWIDTH);
			if (TcoValWidth == comp.TcoValWidth) items.add(TCOVALWIDTH);
			if (TcoBinWidth == comp.TcoBinWidth) items.add(TCOBINWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSTAWIDTH, TCOKEYWIDTH, TCOFILWIDTH, TCOVALWIDTH, TCOBINWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOSTA = 5;
		public static final int TCOKEY = 6;
		public static final int TCOFIL = 7;
		public static final int TCOVAL = 8;
		public static final int TCOBIN = 9;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TRS, TXTSHOWING1, TXTSHOWING2, TCOSTA, TCOKEY, TCOFIL, TCOVAL, TCOBIN));
		};
		...
		public String TcoFil;
		public String TcoVal;
		public String TcoBin;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagMsdcDatAPar");

			String itemtag = "TagitemMsdcDatAPar";
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoFil = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoFil", mask, TCOFIL);
				TcoVal = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoVal", mask, TCOVAL);
				TcoBin = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoBin", mask, TCOBIN);
		...
		public HashSet<Integer> comm(
			...
			if (TcoFil.equals(comp.TcoFil)) items.add(TCOFIL);
			if (TcoVal.equals(comp.TcoVal)) items.add(TCOVAL);
			if (TcoBin.equals(comp.TcoBin)) items.add(TCOBIN);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TRS, TXTSHOWING1, TXTSHOWING2, TCOSTA, TCOKEY, TCOFIL, TCOVAL, TCOBIN));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppMsdc {
		...
		public DpchAppData(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCDATAPARDATA, scrJref);
		...
		public QryMsdcDatAPar.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcDatAParData");
	...
	public class DpchAppDo extends DpchAppMsdc {
		...
		public DpchAppDo(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCDATAPARDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcDatAParDo");
	...
	public class DpchEngData extends DpchEngMsdc {
		...
		public DpchEngData() {
			super(VecMsdcVDpch.DPCHENGMSDCDATAPARDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListMsdcQDatAPar();
			statappqry = (new QryMsdcDatAPar()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryMsdcDatAPar()).new StatShr(0, 0, 0);
			stgiacqry = (new QryMsdcDatAPar()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListMsdcQDatAPar rst;
		public QryMsdcDatAPar.StatApp statappqry;
		public QryMsdcDatAPar.StatShr statshrqry;
		public QryMsdcDatAPar.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngMsdcDatAParData");
