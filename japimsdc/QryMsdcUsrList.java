/**
  * \file QryMsdcUsrList.java
  * Java API code for job QryMsdcUsrList
...
public class QryMsdcUsrList {
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryMsdcUsrList");

			String itemtag = "StatitemAppQryMsdcUsrList";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryMsdcUsrList");

			String itemtag = "StatitemShrQryMsdcUsrList";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryMsdcUsrList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryMsdcUsrList";
