/**
  * \file PnlMsdcPrdList.java
  * Java API code for job PnlMsdcPrdList
...
public class PnlMsdcPrdList {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacMsdcPrdList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacMsdcPrdList";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfMsdcPrdList");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrMsdcPrdList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOSTOWIDTH = 2;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSTAWIDTH, TCOSTOWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacMsdcPrdList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacMsdcPrdList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSTAWIDTH, TCOSTOWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOSTO = 6;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TRS, TXTSHOWING1, TXTSHOWING2, TCOSTA, TCOSTO));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagMsdcPrdList");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TRS, TXTSHOWING1, TXTSHOWING2, TCOSTA, TCOSTO));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppMsdc {
		...
		public DpchAppData(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCPRDLISTDATA, scrJref);
		...
		public QryMsdcPrdList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcPrdListData");
	...
	public class DpchAppDo extends DpchAppMsdc {
		...
		public DpchAppDo(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCPRDLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcPrdListDo");
	...
	public class DpchEngData extends DpchEngMsdc {
		...
		public DpchEngData() {
			super(VecMsdcVDpch.DPCHENGMSDCPRDLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "");
			rst = new ListMsdcQPrdList();
			statappqry = (new QryMsdcPrdList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryMsdcPrdList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryMsdcPrdList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListMsdcQPrdList rst;
		public QryMsdcPrdList.StatApp statappqry;
		public QryMsdcPrdList.StatShr statshrqry;
		public QryMsdcPrdList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngMsdcPrdListData");
