/**
  * \file PnlMsdcPrdHeadbar.java
  * Java API code for job PnlMsdcPrdHeadbar
...
public class PnlMsdcPrdHeadbar {
	/**
	...
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfMsdcPrdHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagMsdcPrdHeadbar");
	...
	public class DpchEngData extends DpchEngMsdc {
		...
		public DpchEngData() {
			super(VecMsdcVDpch.DPCHENGMSDCPRDHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngMsdcPrdHeadbarData");
