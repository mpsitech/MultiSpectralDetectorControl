...
public class PnlMsdcUsr1NSession {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfMsdcUsr1NSession");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppMsdcUsr1NSession");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrMsdcUsr1NSession");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacMsdcUsr1NSession");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacMsdcUsr1NSession";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagMsdcUsr1NSession");
	...
	public class DpchAppData extends DpchAppMsdc {
		...
		public DpchAppData(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCUSR1NSESSIONDATA, scrJref);
		...
		public QryMsdcUsr1NSession.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcUsr1NSessionData");
	...
	public class DpchAppDo extends DpchAppMsdc {
		...
		public DpchAppDo(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCUSR1NSESSIONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcUsr1NSessionDo");
	...
	public class DpchEngData extends DpchEngMsdc {
		...
		public DpchEngData() {
			super(VecMsdcVDpch.DPCHENGMSDCUSR1NSESSIONDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "");
			rst = new ListMsdcQUsr1NSession();
			statappqry = (new QryMsdcUsr1NSession()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryMsdcUsr1NSession()).new StatShr(0, 0, 0);
			stgiacqry = (new QryMsdcUsr1NSession()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListMsdcQUsr1NSession rst;
		public QryMsdcUsr1NSession.StatApp statappqry;
		public QryMsdcUsr1NSession.StatShr statshrqry;
		public QryMsdcUsr1NSession.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngMsdcUsr1NSessionData");
