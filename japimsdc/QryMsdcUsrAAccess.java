/**
  * \file QryMsdcUsrAAccess.java
  * Java API code for job QryMsdcUsrAAccess
...
public class QryMsdcUsrAAccess {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryMsdcUsrAAccess");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryMsdcUsrAAccess");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryMsdcUsrAAccess");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryMsdcUsrAAccess";
