/**
  * \file ContInfMsdcAlert.java
  * Msdc Java API package alert informative content block
...
public class ContInfMsdcAlert extends Block {
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfMsdcAlert");
