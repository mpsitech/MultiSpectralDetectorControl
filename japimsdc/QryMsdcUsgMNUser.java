/**
  * \file QryMsdcUsgMNUser.java
  * Java API code for job QryMsdcUsgMNUser
...
public class QryMsdcUsgMNUser {
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryMsdcUsgMNUser");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryMsdcUsgMNUser");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryMsdcUsgMNUser");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryMsdcUsgMNUser";
