/**
  * \file PnlMsdcDatRef1NFile.java
  * Java API code for job PnlMsdcDatRef1NFile
...
public class PnlMsdcDatRef1NFile {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfMsdcDatRef1NFile");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppMsdcDatRef1NFile");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrMsdcDatRef1NFile");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacMsdcDatRef1NFile");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacMsdcDatRef1NFile";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagMsdcDatRef1NFile");
	...
	public class DpchAppData extends DpchAppMsdc {
		...
		public DpchAppData(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCDATREF1NFILEDATA, scrJref);
		...
		public QryMsdcDatRef1NFile.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcDatRef1NFileData");
	...
	public class DpchAppDo extends DpchAppMsdc {
		...
		public DpchAppDo(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCDATREF1NFILEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcDatRef1NFileDo");
	...
	public class DpchEngData extends DpchEngMsdc {
		...
		public DpchEngData() {
			super(VecMsdcVDpch.DPCHENGMSDCDATREF1NFILEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "");
			rst = new ListMsdcQDatRef1NFile();
			statappqry = (new QryMsdcDatRef1NFile()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryMsdcDatRef1NFile()).new StatShr(0, 0, 0);
			stgiacqry = (new QryMsdcDatRef1NFile()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListMsdcQDatRef1NFile rst;
		public QryMsdcDatRef1NFile.StatApp statappqry;
		public QryMsdcDatRef1NFile.StatShr statshrqry;
		public QryMsdcDatRef1NFile.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngMsdcDatRef1NFileData");
