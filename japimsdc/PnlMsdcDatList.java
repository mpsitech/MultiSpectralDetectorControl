/**
  * \file PnlMsdcDatList.java
  * Java API code for job PnlMsdcDatList
...
public class PnlMsdcDatList {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacMsdcDatList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacMsdcDatList";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfMsdcDatList");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrMsdcDatList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOAFTWIDTH = 1;
		public static final int TCOPRDWIDTH = 2;
		public static final int TCOSTAWIDTH = 3;
		public static final int TCOSTOWIDTH = 4;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOAFTWIDTH, TCOPRDWIDTH, TCOSTAWIDTH, TCOSTOWIDTH));
		};

		public int TcoAftWidth;
		public int TcoPrdWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacMsdcDatList");

			String itemtag = "StgitemIacMsdcDatList";

			if (Xmlio.checkXPath(doc, basexpath)) {
				TcoAftWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoAftWidth", mask, TCOAFTWIDTH);
				TcoPrdWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoPrdWidth", mask, TCOPRDWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacMsdcDatList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoAftWidth", TcoAftWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoPrdWidth", TcoPrdWidth);
		...
		public HashSet<Integer> comm(
			...
			if (TcoAftWidth == comp.TcoAftWidth) items.add(TCOAFTWIDTH);
			if (TcoPrdWidth == comp.TcoPrdWidth) items.add(TCOPRDWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOAFTWIDTH, TCOPRDWIDTH, TCOSTAWIDTH, TCOSTOWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOAFT = 6;
		public static final int TCOPRD = 7;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TRS, TXTSHOWING1, TXTSHOWING2, TCOAFT, TCOPRD, TCOSTA, TCOSTO));
		};
		...
		public String TcoAft;
		public String TcoPrd;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagMsdcDatList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoAft = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoAft", mask, TCOAFT);
				TcoPrd = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoPrd", mask, TCOPRD);
		...
		public HashSet<Integer> comm(
			...
			if (TcoAft.equals(comp.TcoAft)) items.add(TCOAFT);
			if (TcoPrd.equals(comp.TcoPrd)) items.add(TCOPRD);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TRS, TXTSHOWING1, TXTSHOWING2, TCOAFT, TCOPRD, TCOSTA, TCOSTO));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppMsdc {
		...
		public DpchAppData(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCDATLISTDATA, scrJref);
		...
		public QryMsdcDatList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcDatListData");
	...
	public class DpchAppDo extends DpchAppMsdc {
		...
		public DpchAppDo(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCDATLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcDatListDo");
	...
	public class DpchEngData extends DpchEngMsdc {
		...
		public DpchEngData() {
			super(VecMsdcVDpch.DPCHENGMSDCDATLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListMsdcQDatList();
			statappqry = (new QryMsdcDatList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryMsdcDatList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryMsdcDatList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListMsdcQDatList rst;
		public QryMsdcDatList.StatApp statappqry;
		public QryMsdcDatList.StatShr statshrqry;
		public QryMsdcDatList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngMsdcDatListData");
