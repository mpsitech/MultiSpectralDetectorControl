/**
  ...
  * Java API code for record of table TblMsdcQUsrAAccess
...
public class MsdcQUsrAAccess {
	
	public MsdcQUsrAAccess(
				int jnum
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "MsdcQUsrAAccess");
