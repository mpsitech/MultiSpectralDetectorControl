/**
  * \file PnlMsdcUsgList.java
  * Java API code for job PnlMsdcUsgList
...
public class PnlMsdcUsgList {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacMsdcUsgList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacMsdcUsgList";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfMsdcUsgList");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrMsdcUsgList");
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacMsdcUsgList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacMsdcUsgList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOSRF = 5;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagMsdcUsgList");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppMsdc {
		...
		public DpchAppData(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCUSGLISTDATA, scrJref);
		...
		public QryMsdcUsgList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcUsgListData");
	...
	public class DpchAppDo extends DpchAppMsdc {
		...
		public DpchAppDo(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCUSGLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcUsgListDo");
	...
	public class DpchEngData extends DpchEngMsdc {
		...
		public DpchEngData() {
			super(VecMsdcVDpch.DPCHENGMSDCUSGLISTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "");
			rst = new ListMsdcQUsgList();
			statappqry = (new QryMsdcUsgList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryMsdcUsgList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryMsdcUsgList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListMsdcQUsgList rst;
		public QryMsdcUsgList.StatApp statappqry;
		public QryMsdcUsgList.StatShr statshrqry;
		public QryMsdcUsgList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngMsdcUsgListData");
