/**
  * \file PnlMsdcFilList.java
  * Java API code for job PnlMsdcFilList
...
public class PnlMsdcFilList {
	/**
		* VecVDo (full: VecVMsdcFilListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacMsdcFilList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacMsdcFilList");

			String itemtag = "ContitemIacMsdcFilList";
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacMsdcFilList";

			String itemtag;

			if (shorttags) itemtag = "Ci";
			else itemtag = "ContitemIacMsdcFilList";
	...
	/**
	  * ContInf (full: ContInfMsdcFilList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfMsdcFilList");

			String itemtag = "ContitemInfMsdcFilList";
	...
	/**
	  * StatShr (full: StatShrMsdcFilList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrMsdcFilList");

			String itemtag = "StatitemShrMsdcFilList";
	...
	/**
	  * StgIac (full: StgIacMsdcFilList)
	  */
	public class StgIac extends Block {

		public static final int TCOFNMWIDTH = 1;
		public static final int TCORETWIDTH = 2;
		public static final int TCOREUWIDTH = 3;
		public static final int TCOCNTWIDTH = 4;
		public static final int TCOMIMWIDTH = 5;
		public static final int TCOSIZWIDTH = 6;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOFNMWIDTH, TCORETWIDTH, TCOREUWIDTH, TCOCNTWIDTH, TCOMIMWIDTH, TCOSIZWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacMsdcFilList");

			String itemtag = "StgitemIacMsdcFilList";
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacMsdcFilList";

			String itemtag;

			if (shorttags) itemtag = "Si";
			else itemtag = "StgitemIacMsdcFilList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOFNMWIDTH, TCORETWIDTH, TCOREUWIDTH, TCOCNTWIDTH, TCOMIMWIDTH, TCOSIZWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
	  * Tag (full: TagMsdcFilList)
	  */
	public class Tag extends Block {

		public static final int CPT = 1;
		public static final int TXTFOR = 2;
		public static final int TRS = 3;
		public static final int TXTSHOWING1 = 4;
		public static final int TXTSHOWING2 = 5;
		public static final int TCOFNM = 6;
		public static final int TCORET = 7;
		public static final int TCOREU = 8;
		public static final int TCOCNT = 9;
		public static final int TCOMIM = 10;
		public static final int TCOSIZ = 11;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TRS, TXTSHOWING1, TXTSHOWING2, TCOFNM, TCORET, TCOREU, TCOCNT, TCOMIM, TCOSIZ));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagMsdcFilList");

			String itemtag = "TagitemMsdcFilList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TRS, TXTSHOWING1, TXTSHOWING2, TCOFNM, TCORET, TCOREU, TCOCNT, TCOMIM, TCOSIZ));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppMsdcFilListData)
		*/
	public class DpchAppData extends DpchAppMsdc {
		...
		public DpchAppData(
					...
					, ContIac contiac
					, StgIac stgiac
					, QryMsdcFilList.StgIac stgiacqry
					, Integer[] mask
				) {
			super(VecMsdcVDpch.DPCHAPPMSDCFILLISTDATA, scrJref);
		...
		public QryMsdcFilList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcFilListData");
	...
	/**
		* DpchAppDo (full: DpchAppMsdcFilListDo)
		*/
	public class DpchAppDo extends DpchAppMsdc {
		...
		public DpchAppDo(
			...
			super(VecMsdcVDpch.DPCHAPPMSDCFILLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppMsdcFilListDo");
	...
	/**
		* DpchEngData (full: DpchEngMsdcFilListData)
		*/
	public class DpchEngData extends DpchEngMsdc {
		...
		public DpchEngData() {
			super(VecMsdcVDpch.DPCHENGMSDCFILLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "");
			rst = new ListMsdcQFilList();
			statappqry = (new QryMsdcFilList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryMsdcFilList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryMsdcFilList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListMsdcQFilList rst;
		public QryMsdcFilList.StatApp statappqry;
		public QryMsdcFilList.StatShr statshrqry;
		public QryMsdcFilList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngMsdcFilListData");
