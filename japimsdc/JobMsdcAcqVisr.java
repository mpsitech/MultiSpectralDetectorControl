/**
  * \file JobMsdcAcqVisr.java
  * Java API code for job JobMsdcAcqVisr
...
public class JobMsdcAcqVisr {
	...
	public class Stg extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgJobMsdcAcqVisr");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgJobMsdcAcqVisr";
