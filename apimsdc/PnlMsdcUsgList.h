/**
  ...
  * API code for job PnlMsdcUsgList (declarations)
...
namespace PnlMsdcUsgList {
	...
	public:
		DpchAppData(const string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryMsdcUsgList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryMsdcUsgList::StatApp statappqry;
