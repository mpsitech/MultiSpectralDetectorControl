/**
  ...
  * API code for job QryMsdcUsrMNUsergroup (implementation)
...
/******************************************************************************
 class QryMsdcUsrMNUsergroup::StatApp
 ******************************************************************************/

QryMsdcUsrMNUsergroup::StatApp::StatApp(
			const uint firstcol
...
bool QryMsdcUsrMNUsergroup::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryMsdcUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryMsdcUsrMNUsergroup";
...
set<uint> QryMsdcUsrMNUsergroup::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcUsrMNUsergroup::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryMsdcUsrMNUsergroup::StatShr
 ******************************************************************************/

QryMsdcUsrMNUsergroup::StatShr::StatShr(
			const uint ntot
...
bool QryMsdcUsrMNUsergroup::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryMsdcUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryMsdcUsrMNUsergroup";
...
set<uint> QryMsdcUsrMNUsergroup::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcUsrMNUsergroup::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryMsdcUsrMNUsergroup::StgIac
 ******************************************************************************/

QryMsdcUsrMNUsergroup::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryMsdcUsrMNUsergroup::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryMsdcUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryMsdcUsrMNUsergroup";
...
void QryMsdcUsrMNUsergroup::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryMsdcUsrMNUsergroup";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryMsdcUsrMNUsergroup";
...
set<uint> QryMsdcUsrMNUsergroup::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcUsrMNUsergroup::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
