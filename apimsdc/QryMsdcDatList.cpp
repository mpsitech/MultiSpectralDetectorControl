...
/******************************************************************************
 class QryMsdcDatList::VecVOrd
 ******************************************************************************/

uint QryMsdcDatList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryMsdcDatList::VecVOrd::getSref(
			const uint ix
		) {
	if (ix == AFT) return("aft");
...
/******************************************************************************
 class QryMsdcDatList::StatApp
 ******************************************************************************/

QryMsdcDatList::StatApp::StatApp(
			const uint firstcol
...
bool QryMsdcDatList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryMsdcDatList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryMsdcDatList";
...
set<uint> QryMsdcDatList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcDatList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryMsdcDatList::StatShr
 ******************************************************************************/

QryMsdcDatList::StatShr::StatShr(
			const uint ntot
...
bool QryMsdcDatList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryMsdcDatList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryMsdcDatList";
...
set<uint> QryMsdcDatList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcDatList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryMsdcDatList::StgIac
 ******************************************************************************/

QryMsdcDatList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryMsdcDatList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryMsdcDatList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryMsdcDatList";
...
void QryMsdcDatList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryMsdcDatList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryMsdcDatList";
...
set<uint> QryMsdcDatList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcDatList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
