/**
  * \file CrdMsdcPrd.cpp
  * API code for job CrdMsdcPrd (implementation)
...
bool CrdMsdcPrd::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfMsdcPrd");
	else
...
bool CrdMsdcPrd::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppMsdcPrd");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> CrdMsdcPrd::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdMsdcPrd::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdMsdcPrd::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrMsdcPrd");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool CrdMsdcPrd::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagMsdcPrd");
	else
		basefound = checkXPath(docctx, basexpath);
...
CrdMsdcPrd::DpchAppDo::DpchAppDo(
			...
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCPRDDO, scrJref) {
...
void CrdMsdcPrd::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppMsdcPrdDo");
...
CrdMsdcPrd::DpchEngData::DpchEngData() : DpchEngMsdc(VecMsdcVDpch::DPCHENGMSDCPRDDATA) {
...
void CrdMsdcPrd::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngMsdcPrdData");
	else
		basefound = checkXPath(docctx, basexpath);
