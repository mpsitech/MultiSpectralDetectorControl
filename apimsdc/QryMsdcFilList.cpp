/**
  ...
  * API code for job QryMsdcFilList (implementation)
...
/******************************************************************************
 class QryMsdcFilList::VecVOrd
 ******************************************************************************/

uint QryMsdcFilList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryMsdcFilList::VecVOrd::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class QryMsdcFilList::StatApp
 ******************************************************************************/

QryMsdcFilList::StatApp::StatApp(
			const uint firstcol
...
bool QryMsdcFilList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryMsdcFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryMsdcFilList";
...
set<uint> QryMsdcFilList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcFilList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryMsdcFilList::StatShr
 ******************************************************************************/

QryMsdcFilList::StatShr::StatShr(
			const uint ntot
...
bool QryMsdcFilList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryMsdcFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryMsdcFilList";
...
set<uint> QryMsdcFilList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcFilList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryMsdcFilList::StgIac
 ******************************************************************************/

QryMsdcFilList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryMsdcFilList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryMsdcFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryMsdcFilList";
...
void QryMsdcFilList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryMsdcFilList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryMsdcFilList";
...
set<uint> QryMsdcFilList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcFilList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
