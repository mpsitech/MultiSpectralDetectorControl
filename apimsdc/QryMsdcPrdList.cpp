/**
  ...
  * API code for job QryMsdcPrdList (implementation)
...
/******************************************************************************
 class QryMsdcPrdList::VecVOrd
 ******************************************************************************/

uint QryMsdcPrdList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryMsdcPrdList::VecVOrd::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class QryMsdcPrdList::StatApp
 ******************************************************************************/

QryMsdcPrdList::StatApp::StatApp(
			const uint firstcol
...
bool QryMsdcPrdList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryMsdcPrdList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryMsdcPrdList";
...
set<uint> QryMsdcPrdList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcPrdList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryMsdcPrdList::StatShr
 ******************************************************************************/

QryMsdcPrdList::StatShr::StatShr(
			const uint ntot
...
bool QryMsdcPrdList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryMsdcPrdList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryMsdcPrdList";
...
set<uint> QryMsdcPrdList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcPrdList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryMsdcPrdList::StgIac
 ******************************************************************************/

QryMsdcPrdList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryMsdcPrdList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryMsdcPrdList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryMsdcPrdList";
...
void QryMsdcPrdList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryMsdcPrdList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryMsdcPrdList";
...
set<uint> QryMsdcPrdList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcPrdList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
