...
/******************************************************************************
 class PnlMsdcFilDetail::VecVDo
 ******************************************************************************/

uint PnlMsdcFilDetail::VecVDo::getIx(
			const string& sref
		) {
...
string PnlMsdcFilDetail::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlMsdcFilDetail::ContIac
 ******************************************************************************/

PnlMsdcFilDetail::ContIac::ContIac(
			const string& TxfFnm
...
bool PnlMsdcFilDetail::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacMsdcFilDetail");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacMsdcFilDetail";
...
void PnlMsdcFilDetail::ContIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "ContIacMsdcFilDetail";

	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemIacMsdcFilDetail";
...
set<uint> PnlMsdcFilDetail::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlMsdcFilDetail::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlMsdcFilDetail::ContInf
 ******************************************************************************/
...
bool PnlMsdcFilDetail::ContInf::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfMsdcFilDetail");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfMsdcFilDetail";
...
set<uint> PnlMsdcFilDetail::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlMsdcFilDetail::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlMsdcFilDetail::StatApp
 ******************************************************************************/

PnlMsdcFilDetail::StatApp::StatApp(
	...
	mask = {IXMSDCVEXPSTATE, LSTCLUALT, PUPCNTALT, PUPMIMALT, LSTCLUNUMFIRSTDISP};
};

bool PnlMsdcFilDetail::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppMsdcFilDetail");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppMsdcFilDetail";
...
set<uint> PnlMsdcFilDetail::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlMsdcFilDetail::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {IXMSDCVEXPSTATE, LSTCLUALT, PUPCNTALT, PUPMIMALT, LSTCLUNUMFIRSTDISP};
	for (auto it=commitems.begin();it!=commitems.end();it++) diffitems.erase(*it);
...
/******************************************************************************
 class PnlMsdcFilDetail::StatShr
 ******************************************************************************/

PnlMsdcFilDetail::StatShr::StatShr(
...
bool PnlMsdcFilDetail::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrMsdcFilDetail");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrMsdcFilDetail";
...
set<uint> PnlMsdcFilDetail::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlMsdcFilDetail::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlMsdcFilDetail::Tag
 ******************************************************************************/

PnlMsdcFilDetail::Tag::Tag(
			const string& Cpt
			, const string& CptFnm
			, const string& CptClu
			, const string& CptReu
...
bool PnlMsdcFilDetail::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagMsdcFilDetail");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemMsdcFilDetail";
...
void PnlMsdcFilDetail::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppMsdcFilDetailData");
...
string PnlMsdcFilDetail::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlMsdcFilDetail::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppMsdcFilDetailDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/msdc");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
string PnlMsdcFilDetail::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlMsdcFilDetail::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngMsdcFilDetailData");
	else
		basefound = checkXPath(docctx, basexpath);
