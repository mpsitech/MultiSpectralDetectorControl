/**
  ...
  * API code for job PnlMsdcDatRef1NFile (declarations)
...
namespace PnlMsdcDatRef1NFile {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryMsdcDatRef1NFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryMsdcDatRef1NFile::StatApp statappqry;
