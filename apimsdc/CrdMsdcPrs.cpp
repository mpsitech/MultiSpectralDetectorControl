/**
  * \file CrdMsdcPrs.cpp
  * API code for job CrdMsdcPrs (implementation)
...
bool CrdMsdcPrs::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfMsdcPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfMsdcPrs";
...
bool CrdMsdcPrs::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppMsdcPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppMsdcPrs";
...
set<uint> CrdMsdcPrs::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdMsdcPrs::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdMsdcPrs::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrMsdcPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrMsdcPrs";
...
bool CrdMsdcPrs::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagMsdcPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemMsdcPrs";
...
CrdMsdcPrs::DpchAppDo::DpchAppDo(
			...
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCPRSDO, scrJref) {
...
void CrdMsdcPrs::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppMsdcPrsDo");
...
CrdMsdcPrs::DpchEngData::DpchEngData() : DpchEngMsdc(VecMsdcVDpch::DPCHENGMSDCPRSDATA) {
...
void CrdMsdcPrs::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngMsdcPrsData");
	else
		basefound = checkXPath(docctx, basexpath);
