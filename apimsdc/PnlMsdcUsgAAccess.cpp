...
/******************************************************************************
 class PnlMsdcUsgAAccess::VecVDo
 ******************************************************************************/

uint PnlMsdcUsgAAccess::VecVDo::getIx(
			const string& sref
		) {
...
string PnlMsdcUsgAAccess::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlMsdcUsgAAccess::ContInf
 ******************************************************************************/

PnlMsdcUsgAAccess::ContInf::ContInf(
...
bool PnlMsdcUsgAAccess::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfMsdcUsgAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfMsdcUsgAAccess";
...
set<uint> PnlMsdcUsgAAccess::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlMsdcUsgAAccess::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlMsdcUsgAAccess::StatApp
 ******************************************************************************/

PnlMsdcUsgAAccess::StatApp::StatApp(
...
bool PnlMsdcUsgAAccess::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppMsdcUsgAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppMsdcUsgAAccess";
...
set<uint> PnlMsdcUsgAAccess::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlMsdcUsgAAccess::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlMsdcUsgAAccess::StatShr
 ******************************************************************************/

PnlMsdcUsgAAccess::StatShr::StatShr(
...
bool PnlMsdcUsgAAccess::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrMsdcUsgAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrMsdcUsgAAccess";
...
set<uint> PnlMsdcUsgAAccess::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlMsdcUsgAAccess::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlMsdcUsgAAccess::StgIac
 ******************************************************************************/

PnlMsdcUsgAAccess::StgIac::StgIac(
...
bool PnlMsdcUsgAAccess::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacMsdcUsgAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacMsdcUsgAAccess";
...
void PnlMsdcUsgAAccess::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacMsdcUsgAAccess";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacMsdcUsgAAccess";
...
set<uint> PnlMsdcUsgAAccess::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlMsdcUsgAAccess::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlMsdcUsgAAccess::Tag
 ******************************************************************************/

PnlMsdcUsgAAccess::Tag::Tag(
			const string& Cpt
			, const string& Trs
...
bool PnlMsdcUsgAAccess::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagMsdcUsgAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemMsdcUsgAAccess";
...
/******************************************************************************
 class PnlMsdcUsgAAccess::DpchAppData
 ******************************************************************************/

PnlMsdcUsgAAccess::DpchAppData::DpchAppData(
			const string& scrJref
			, StgIac* stgiac
			, QryMsdcUsgAAccess::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCUSGAACCESSDATA, scrJref)
		{
...
string PnlMsdcUsgAAccess::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlMsdcUsgAAccess::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppMsdcUsgAAccessData");
...
/******************************************************************************
 class PnlMsdcUsgAAccess::DpchAppDo
 ******************************************************************************/

PnlMsdcUsgAAccess::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) :
			DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCUSGAACCESSDO, scrJref)
		{
...
string PnlMsdcUsgAAccess::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlMsdcUsgAAccess::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppMsdcUsgAAccessDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/msdc");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
/******************************************************************************
 class PnlMsdcUsgAAccess::DpchEngData
 ******************************************************************************/

PnlMsdcUsgAAccess::DpchEngData::DpchEngData() :
			DpchEngMsdc(VecMsdcVDpch::DPCHENGMSDCUSGAACCESSDATA)
		{
	feedFCsiQst.tag = "FeedFCsiQst";
};

string PnlMsdcUsgAAccess::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlMsdcUsgAAccess::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngMsdcUsgAAccessData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryMsdcUsgAAccess::StatApp();
		statshrqry = QryMsdcUsgAAccess::StatShr();
		stgiacqry = QryMsdcUsgAAccess::StgIac();
	};
};
