/**
  ...
  * API code for job QryMsdcUsgAAccess (implementation)
...
/******************************************************************************
 class QryMsdcUsgAAccess::StatApp
 ******************************************************************************/

QryMsdcUsgAAccess::StatApp::StatApp(
			const uint firstcol
...
bool QryMsdcUsgAAccess::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryMsdcUsgAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryMsdcUsgAAccess";
...
set<uint> QryMsdcUsgAAccess::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcUsgAAccess::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryMsdcUsgAAccess::StatShr
 ******************************************************************************/

QryMsdcUsgAAccess::StatShr::StatShr(
			const uint ntot
...
bool QryMsdcUsgAAccess::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryMsdcUsgAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryMsdcUsgAAccess";
...
set<uint> QryMsdcUsgAAccess::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcUsgAAccess::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryMsdcUsgAAccess::StgIac
 ******************************************************************************/

QryMsdcUsgAAccess::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryMsdcUsgAAccess::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryMsdcUsgAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryMsdcUsgAAccess";
...
void QryMsdcUsgAAccess::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryMsdcUsgAAccess";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryMsdcUsgAAccess";
...
set<uint> QryMsdcUsgAAccess::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcUsgAAccess::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
