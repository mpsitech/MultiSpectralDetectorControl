/**
  ...
  * API code for job PnlMsdcUsrMNUsergroup (implementation)
...
bool PnlMsdcUsrMNUsergroup::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfMsdcUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfMsdcUsrMNUsergroup";
...
PnlMsdcUsrMNUsergroup::StatApp::StatApp(
...
bool PnlMsdcUsrMNUsergroup::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppMsdcUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppMsdcUsrMNUsergroup";
...
set<uint> PnlMsdcUsrMNUsergroup::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlMsdcUsrMNUsergroup::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlMsdcUsrMNUsergroup::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrMsdcUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrMsdcUsrMNUsergroup";
...
bool PnlMsdcUsrMNUsergroup::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagMsdcUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemMsdcUsrMNUsergroup";
...
PnlMsdcUsrMNUsergroup::DpchAppData::DpchAppData(
			...
			, const set<uint>& mask
		) : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCUSRMNUSERGROUPDATA, scrJref) {
...
void PnlMsdcUsrMNUsergroup::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppMsdcUsrMNUsergroupData");
...
PnlMsdcUsrMNUsergroup::DpchAppDo::DpchAppDo(
			...
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppMsdc(VecMsdcVDpch::DPCHAPPMSDCUSRMNUSERGROUPDO, scrJref) {
...
void PnlMsdcUsrMNUsergroup::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppMsdcUsrMNUsergroupDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/msdc");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlMsdcUsrMNUsergroup::DpchEngData::DpchEngData() : DpchEngMsdc(VecMsdcVDpch::DPCHENGMSDCUSRMNUSERGROUPDATA) {
...
void PnlMsdcUsrMNUsergroup::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngMsdcUsrMNUsergroupData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryMsdcUsrMNUsergroup::StatApp();
		statshrqry = QryMsdcUsrMNUsergroup::StatShr();
