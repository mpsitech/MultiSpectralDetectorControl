/**
  ...
  * API code for job QryMsdcUsrAAccess (implementation)
...
/******************************************************************************
 class QryMsdcUsrAAccess::StatApp
 ******************************************************************************/

QryMsdcUsrAAccess::StatApp::StatApp(
			const uint firstcol
...
bool QryMsdcUsrAAccess::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryMsdcUsrAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryMsdcUsrAAccess";
...
set<uint> QryMsdcUsrAAccess::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcUsrAAccess::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryMsdcUsrAAccess::StatShr
 ******************************************************************************/

QryMsdcUsrAAccess::StatShr::StatShr(
			const uint ntot
...
bool QryMsdcUsrAAccess::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryMsdcUsrAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryMsdcUsrAAccess";
...
set<uint> QryMsdcUsrAAccess::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcUsrAAccess::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryMsdcUsrAAccess::StgIac
 ******************************************************************************/

QryMsdcUsrAAccess::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryMsdcUsrAAccess::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryMsdcUsrAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryMsdcUsrAAccess";
...
void QryMsdcUsrAAccess::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryMsdcUsrAAccess";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryMsdcUsrAAccess";
...
set<uint> QryMsdcUsrAAccess::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcUsrAAccess::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
