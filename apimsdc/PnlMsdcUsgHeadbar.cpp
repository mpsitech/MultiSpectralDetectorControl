/**
  * \file PnlMsdcUsgHeadbar.cpp
  * API code for job PnlMsdcUsgHeadbar (implementation)
...
/******************************************************************************
 class PnlMsdcUsgHeadbar::StgInf
 ******************************************************************************/

PnlMsdcUsgHeadbar::StgInf::StgInf(
...
bool PnlMsdcUsgHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfMsdcUsgHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfMsdcUsgHeadbar";
...
set<uint> PnlMsdcUsgHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlMsdcUsgHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {, MENAPPWIDTH, MENCRDCPTWIDTH, MENCRDWIDTH};
...
/******************************************************************************
 class PnlMsdcUsgHeadbar::Tag
 ******************************************************************************/

PnlMsdcUsgHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) : Block() {
	this->MenApp = MenApp;
...
bool PnlMsdcUsgHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagMsdcUsgHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemMsdcUsgHeadbar";
...
/******************************************************************************
 class PnlMsdcUsgHeadbar::DpchEngData
 ******************************************************************************/

PnlMsdcUsgHeadbar::DpchEngData::DpchEngData() : DpchEngMsdc(VecMsdcVDpch::DPCHENGMSDCUSGHEADBARDATA) {
};

string PnlMsdcUsgHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlMsdcUsgHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngMsdcUsgHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
