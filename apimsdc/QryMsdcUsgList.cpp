...
/******************************************************************************
 class QryMsdcUsgList::VecVOrd
 ******************************************************************************/

uint QryMsdcUsgList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryMsdcUsgList::VecVOrd::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class QryMsdcUsgList::StatApp
 ******************************************************************************/

QryMsdcUsgList::StatApp::StatApp(
			const uint firstcol
...
bool QryMsdcUsgList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryMsdcUsgList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryMsdcUsgList";
...
set<uint> QryMsdcUsgList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcUsgList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryMsdcUsgList::StatShr
 ******************************************************************************/

QryMsdcUsgList::StatShr::StatShr(
			const uint ntot
...
bool QryMsdcUsgList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryMsdcUsgList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryMsdcUsgList";
...
set<uint> QryMsdcUsgList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcUsgList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryMsdcUsgList::StgIac
 ******************************************************************************/

QryMsdcUsgList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryMsdcUsgList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryMsdcUsgList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryMsdcUsgList";
...
void QryMsdcUsgList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryMsdcUsgList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryMsdcUsgList";
...
set<uint> QryMsdcUsgList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryMsdcUsgList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
