...
namespace VecMsdcVDpch {
	...
	const uint DPCHAPPMSDCLIVTRACKDATA = 92;
	const uint DPCHAPPMSDCLIVTRACKDO = 93;
	const uint DPCHAPPMSDCLIVVIDEODATA = 94;
	const uint DPCHAPPMSDCLIVVIDEODO = 95;
	const uint DPCHAPPMSDCNAVADMINDATA = 96;
	const uint DPCHAPPMSDCNAVADMINDO = 97;
	const uint DPCHAPPMSDCNAVDO = 98;
	const uint DPCHAPPMSDCNAVOPRDATA = 99;
	const uint DPCHAPPMSDCNAVOPRDO = 100;
	const uint DPCHAPPMSDCNAVPREDO = 101;
	const uint DPCHAPPMSDCPRD1NDATADATA = 102;
	const uint DPCHAPPMSDCPRD1NDATADO = 103;
	const uint DPCHAPPMSDCPRDDETAILDATA = 104;
	const uint DPCHAPPMSDCPRDDETAILDO = 105;
	const uint DPCHAPPMSDCPRDDO = 106;
	const uint DPCHAPPMSDCPRDLISTDATA = 107;
	const uint DPCHAPPMSDCPRDLISTDO = 108;
	const uint DPCHAPPMSDCPRDRECDO = 109;
	const uint DPCHAPPMSDCPRSDETAILDATA = 110;
	const uint DPCHAPPMSDCPRSDETAILDO = 111;
	const uint DPCHAPPMSDCPRSDO = 112;
	const uint DPCHAPPMSDCPRSLISTDATA = 113;
	const uint DPCHAPPMSDCPRSLISTDO = 114;
	const uint DPCHAPPMSDCPRSRECDO = 115;
	const uint DPCHAPPMSDCRESUME = 116;
	const uint DPCHAPPMSDCSCFACQUISDATA = 117;
	const uint DPCHAPPMSDCSCFACQUISDO = 118;
	const uint DPCHAPPMSDCSCFACTUDATA = 119;
	const uint DPCHAPPMSDCSCFACTUDO = 120;
	const uint DPCHAPPMSDCSCFDO = 121;
	const uint DPCHAPPMSDCSCFPRCCTLDO = 122;
	const uint DPCHAPPMSDCSCFSOURCEDATA = 123;
	const uint DPCHAPPMSDCSCFSOURCEDO = 124;
	const uint DPCHAPPMSDCUSGAACCESSDATA = 125;
	const uint DPCHAPPMSDCUSGAACCESSDO = 126;
	const uint DPCHAPPMSDCUSGDETAILDATA = 127;
	const uint DPCHAPPMSDCUSGDETAILDO = 128;
	const uint DPCHAPPMSDCUSGDO = 129;
	const uint DPCHAPPMSDCUSGLISTDATA = 130;
	const uint DPCHAPPMSDCUSGLISTDO = 131;
	const uint DPCHAPPMSDCUSGMNUSERDATA = 132;
	const uint DPCHAPPMSDCUSGMNUSERDO = 133;
	const uint DPCHAPPMSDCUSGRECDO = 134;
	const uint DPCHAPPMSDCUSR1NSESSIONDATA = 135;
	const uint DPCHAPPMSDCUSR1NSESSIONDO = 136;
	const uint DPCHAPPMSDCUSRAACCESSDATA = 137;
	const uint DPCHAPPMSDCUSRAACCESSDO = 138;
	const uint DPCHAPPMSDCUSRDETAILDATA = 139;
	const uint DPCHAPPMSDCUSRDETAILDO = 140;
	const uint DPCHAPPMSDCUSRDO = 141;
	const uint DPCHAPPMSDCUSRLISTDATA = 142;
	const uint DPCHAPPMSDCUSRLISTDO = 143;
	const uint DPCHAPPMSDCUSRMNUSERGROUPDATA = 144;
	const uint DPCHAPPMSDCUSRMNUSERGROUPDO = 145;
	const uint DPCHAPPMSDCUSRRECDO = 146;
	const uint DPCHAPPROOTMSDCLOGIN = 147;
