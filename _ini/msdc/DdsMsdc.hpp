...
#ifndef DdsMsdc_1182983966_hpp
#define DdsMsdc_1182983966_hpp
...
namespace DdsJobMsdcAcqLwir {
    ...
    class NDDSUSERDllExport setOutput_req {
      ...
      public:
        ...
        vecsref& srefIxMsdcVSqrgrp() OMG_NOEXCEPT; 
        const vecsref& srefIxMsdcVSqrgrp() const OMG_NOEXCEPT;
        void srefIxMsdcVSqrgrp(const vecsref& value);
...
namespace DdsJobMsdcAcqVisl {
    ...
    class NDDSUSERDllExport setOutput_req {
      ...
      public:
        ...
        vecsref& srefIxMsdcVCamres() OMG_NOEXCEPT; 
        const vecsref& srefIxMsdcVCamres() const OMG_NOEXCEPT;
        void srefIxMsdcVCamres(const vecsref& value);
...
namespace DdsJobMsdcActAlign {
    ...
    class NDDSUSERDllExport setWave_req {
      ...
      public:
        ...
        vecsref& srefIxVFunction() OMG_NOEXCEPT; 
        const vecsref& srefIxVFunction() const OMG_NOEXCEPT;
        void srefIxVFunction(const vecsref& value);
